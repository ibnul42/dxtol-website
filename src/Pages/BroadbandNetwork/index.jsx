                    ...
                    <div className="max-w-6xl mx-auto px-2 pt-2 pb-10 flex flex-col items-center gap-3">
                        <div className="my-2">
                            ...
                            <div className="flex gap-5 justify-center">
                                <button className='px-6 py-3 btngradient text-white w-fit font-secure font-medium rounded flex gap-2 items-center'>Check Packages</button>
                                <button className='px-6 py-3 text-white w-fit font-secure font-medium rounded flex gap-2 items-center border-gradient-network '>Watch  Demo <img src="/assets/icon/play.svg" className='h-3 w-3' alt="play" /></button>
                            </div>
                        </div>
                        <div className="my-5 flex flex-col justify-center items-center">
                            <p className='text-yellow font-secure font-semibold leading-7 uppercase'>Empowering Networks:</p>
                            <p className='text-xl md:text-2xl lg:text-4xl text-gradient font-secure font-extrabold flex flex-col items-center'><span>We Provide High Speed</span> <span>Internet Connection</span></p>
                        </div>
                        {/* service */}
